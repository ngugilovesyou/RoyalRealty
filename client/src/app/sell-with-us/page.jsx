...
import { CheckCircle, XCircle, Loader2, Upload, X, Image as ImageIcon } from "lucide-react";
...
export default function SellWithUsForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // In production, you would send formDataToSend to your API
      // await fetch('/api/sell-land', {
      //   method: 'POST',
      //   body: formDataToSend
      // });
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className={labelClasses}>
                  Land Images (Optional - Max 5 images, 5MB each)
                </label>
                        ...
                        >
                          ...
                          <div className="absolute bottom-2 left-2 bg-black/50 text-white text-xs px-2 py-1 rounded">
                            {images[index]?.name?.length > 15 
                              ? images[index]?.name.substring(0, 12) + '...' 
                              : images[index]?.name}
                          </div>
                        </motion.div>
                      ))}
              ...
              <p className="text-xs text-center text-[#666] mt-4">
                ...
                <Link href="/privacy" className="text-[#2F6B3C] hover:underline">
                  Privacy Policy
                </Link>{' '}
                and{' '}
                <Link href="/terms" className="text-[#2F6B3C] hover:underline">
                  Terms of Service
                </Link>
